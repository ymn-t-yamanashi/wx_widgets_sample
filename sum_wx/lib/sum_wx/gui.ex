defmodule SumWx.GUI do
  ...
  def init(state) do
    ...
    plus_label = :wxStaticText.new(panel, -1, ~c"+")
    input2 = :wxTextCtrl.new(panel, 102, ~c"")
    eq_label = :wxStaticText.new(panel, -1, ~c"=")
    result_label = :wxStaticText.new(panel, -1, ~c"0")
    {_bw, bh} = :wxWindow.getBestSize(input1)
    :wxWindow.setMinSize(plus_label, {20, bh})
    :wxWindow.setMinSize(eq_label, {20, bh})
    :wxWindow.setMinSize(result_label, {40, bh})
    ...
    :wxSizer.add(row, plus_label, flag: 16, border: 8)
    :wxSizer.add(row, input2, proportion: 1, flag: 16, border: 8)
    :wxSizer.add(row, eq_label, flag: 16, border: 8)
    :wxSizer.add(row, result_label, flag: 16, border: 8)
