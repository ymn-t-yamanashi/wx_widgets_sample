defmodule ElixirWxHandPoseViewer.GUI do
  ...
  def init(state) do
    wx = :wx.new()
    frame = :wxFrame.new(wx, -1, ~c"Elixir wx Hand Pose Viewer", size: {900, 640})
  ...
  def handle_info(:refresh, state) do
    state =
      case ElixirWxHandPoseViewer.Camera.latest_frame() do
  ...
  defp handle_key(32, state) do
    case ElixirWxHandPoseViewer.Camera.toggle_pause() do
      {:ok, paused} ->
